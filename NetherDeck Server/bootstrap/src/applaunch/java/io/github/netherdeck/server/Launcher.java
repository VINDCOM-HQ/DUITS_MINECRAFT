package io.github.netherdeck.server;
...
public class Launcher {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        if (javaVersion < MIN_CLASS_VERSION) {
            System.err.println("NetherDeck requires Java " + MIN_JAVA_VERSION);
        ...
        if (javaVersion > MAX_CLASS_VERSION) {
            System.err.println("Warning: NetherDeck is known to be compatible with up to Java " + MAX_JAVA_VERSION + " and may not run on later versions");
            System.err.println("Current: " + System.getProperty("java.version"));
            System.err.flush();
            Thread.sleep(3000);
        }

        try (InputStream input = Launcher.class.getResourceAsStream("/netherdeck-server-launch.properties")) {
