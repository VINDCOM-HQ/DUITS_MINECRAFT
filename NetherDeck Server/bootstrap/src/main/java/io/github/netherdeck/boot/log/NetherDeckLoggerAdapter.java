...
public class NetherDeckLoggerAdapter extends CoreLoggerAdapter {

    @Override
    protected Logger newLogger(final String name, final LoggerContext context) {
        Logger logger = super.newLogger(name, context);
        if (logger instanceof ApiLogger) {
            return new NetherDeckJulLogger(logger);
        } else {
            return logger;
        }
    }

    public static class NetherDeckJulLogger extends Logger {

        private final Logger logger;

        protected NetherDeckJulLogger(Logger logger) {
