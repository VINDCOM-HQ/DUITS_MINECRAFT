package io.github.netherdeck.boot.fabric.mod;
...
public class NetherDeckGameProvider extends MinecraftGameProvider {
    ...
    public void initialize(FabricLauncher launcher) {
        ...
        for (var lib : System.getProperty("netherdeck.fabric.classpath").split(File.pathSeparator)) {
    ...
    public Arguments getArguments() {
        ...
        var builtinMods = System.getProperty("netherdeck.fabric.builtinMods");
    ...
    private String getNetherDeckVersion() throws Exception {
    ...
    private Path extract() throws Exception {
        var version = getNetherDeckVersion();
    ...
    public void unlockClassPath(FabricLauncher launcher) {
        ...
        try {
            ...
            var ctor = launcher.loadIntoTarget("io.github.netherdeck.fabric.boot.FabricBootstrap").getConstructor();
    ...
    public String getRawGameVersion() {
        try {
            return super.getRawGameVersion() + " NetherDeck " + getNetherDeckVersion();
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    }
