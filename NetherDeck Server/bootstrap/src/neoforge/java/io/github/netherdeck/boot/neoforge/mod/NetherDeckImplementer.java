...
import io.github.netherdeck.boot.asm.*;
...
public class NetherDeckImplementer implements ILaunchPluginService {

    static final Logger LOGGER = NetherDeckI18nLogger.getLogger("Implementer");
    ...
    public NetherDeckImplementer() {
        this(detectTransformLogger());
    }

    public NetherDeckImplementer(boolean logger) {
        this.logger = logger;
    }
