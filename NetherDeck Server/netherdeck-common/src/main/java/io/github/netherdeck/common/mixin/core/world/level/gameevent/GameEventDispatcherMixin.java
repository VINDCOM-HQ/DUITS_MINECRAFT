package io.github.netherdeck.common.mixin.core.world.level.gameevent;
...
public class GameEventDispatcherMixin {
    ...
    private void netherdeck$gameEvent(Holder<GameEvent> holder, Vec3 vec3, GameEvent.Context context, @Local(ordinal = 0) int i) throws Throwable {
