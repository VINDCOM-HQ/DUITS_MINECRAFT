package io.github.netherdeck.common.mod.util.remapper.resource;
    ...
    private static class RemapSourceConnection extends URLConnection {
        ...
        public void connect() throws IOException {
            ...
            if (className.startsWith("net/minecraft/") || className.equals("com/mojang/brigadier/tree/CommandNode")) {
                bytes = NetherDeckCommon.api().platformRemapClass(bytes);
            }
            this.array = NetherDeckRemapper.getResourceMapper().remapClassFile(bytes, GlobalClassRepo.INSTANCE);
        }
