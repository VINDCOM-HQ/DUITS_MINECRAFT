...
import io.github.netherdeck.common.bridge.bukkit.EntityTypeBridge;
...
public class EntityClassLookup {
    ...
    public static void init() {
        ...
        for (Class<?> entityClass : allEntityClasses) {
            ...
            if (optional.isEmpty()) {
                error = true;
                NetherDeckServer.LOGGER.error(entityClass + " has no valid entity class mapping");
            }
        }
        if (error) {
    ...
    static {
        // abstract types
        add(Entity.class, new EntityClass<>(org.bukkit.entity.Entity.class, NetherDeckModEntity.class, NetherDeckModEntity::new));
        add(AbstractSkeleton.class, new EntityClass<>(org.bukkit.entity.AbstractSkeleton.class, NetherDeckModAbstractSkeleton.class, NetherDeckModAbstractSkeleton::new));
        add(Mob.class, new EntityClass<>(org.bukkit.entity.Mob.class, org.bukkit.craftbukkit.v.entity.CraftMob.class, NetherDeckModMob::new));
        add(AbstractMinecart.class, new EntityClass<>(org.bukkit.entity.Minecart.class, NetherDeckModMinecart.class, NetherDeckModMinecart::new));
        add(AbstractMinecartContainer.class, new EntityClass<>(org.bukkit.entity.Minecart.class, NetherDeckModMinecartContainer.class, NetherDeckModMinecartContainer::new));
        add(AbstractHorse.class, new EntityClass<>(org.bukkit.entity.AbstractHorse.class, NetherDeckModHorse.class, NetherDeckModHorse::new));
        add(AbstractChestedHorse.class, new EntityClass<>(org.bukkit.entity.ChestedHorse.class, NetherDeckModChestedHorse.class, NetherDeckModChestedHorse::new));
        add(Projectile.class, new EntityClass<>(org.bukkit.entity.Projectile.class, NetherDeckModProjectile.class, NetherDeckModProjectile::new));
        add(Raider.class, new EntityClass<>(org.bukkit.entity.Raider.class, NetherDeckModRaider.class, NetherDeckModRaider::new));
        add(VehicleEntity.class, new EntityClass<>(org.bukkit.entity.Vehicle.class, NetherDeckModVehicle.class, NetherDeckModVehicle::new));
        add(AbstractWindCharge.class, new EntityClass<>(org.bukkit.entity.AbstractWindCharge.class, NetherDeckModWindCharge.class, NetherDeckModWindCharge::new));
        ...
        add(ThrowableItemProjectile.class, new EntityClass<>(org.bukkit.entity.ThrowableProjectile.class, NetherDeckModThrowableProjectile.class, NetherDeckModThrowableProjectile::new));
        ...
        add(WindCharge.class, new EntityClass<>(org.bukkit.entity.WindCharge.class, org.bukkit.craftbukkit.v.entity.CraftWindCharge.class, org.bukkit.craftbukkit.v.entity.CraftWindCharge::new));
        ...
        add(ItemEntity.class, new EntityClass<>(org.bukkit.entity.Item.class, org.bukkit.craftbukkit.v.entity.CraftItem.class, org.bukkit.craftbukkit.v.entity.CraftItem::new));
        ...
        add(MinecartTNT.class, new EntityClass<>(org.bukkit.entity.minecart.ExplosiveMinecart.class, org.bukkit.craftbukkit.v.entity.CraftMinecartTNT.class, CraftEntityTypes.getEntityTypeData(org.bukkit.entity.minecart.ExplosiveMinecart.class).convertFunction()::apply));
