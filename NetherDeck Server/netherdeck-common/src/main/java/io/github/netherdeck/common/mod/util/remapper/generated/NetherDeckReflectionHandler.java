package io.github.netherdeck.common.mod.util.remapper.generated;

import io.github.netherdeck.api.NetherDeckVersion;
import io.github.netherdeck.api.Unsafe;
import io.github.netherdeck.common.mod.util.remapper.*;
import io.github.netherdeck.common.util.Enumerations;
...
public class NetherDeckReflectionHandler extends ClassLoader {
    ...
    public static String handlePackageGetName(String name) {
        if (name.startsWith(PREFIX)) {
            return PREFIX + "server." + NetherDeckVersion.current().packageName();
        } else {
            return name;
        }
    }
    ...
    public static Object[] handleMethodInvoke(Method method, Object src, Object[] param) throws Throwable {
        Object[] ret = NetherDeckRedirectAdapter.runHandle(remapper, method, src, param);
        if (ret != null) {
            return ret;
        } else {
    ...
    public static Object redirectMethodInvoke(Method method, Object src, Object[] param) throws Throwable {
        Object ret = NetherDeckRedirectAdapter.runRedirect(remapper, method, src, param);
        if (ret != remapper) {
            return ret;
        } else {
    ...
    public static byte[] transformOrAdd(ClassLoader loader, byte[] bytes) {
        ...
        if (rcl != null) {
            ...
            NetherDeckRedirectAdapter.scanMethod(bytes);
            return bytes;
        }
    }
}
