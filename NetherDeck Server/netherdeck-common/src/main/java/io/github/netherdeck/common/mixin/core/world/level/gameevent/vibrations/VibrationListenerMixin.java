package io.github.netherdeck.common.mixin.core.world.level.gameevent.vibrations;
...
public abstract class VibrationListenerMixin {
    ...
    private boolean netherdeck$gameEvent(VibrationSystem.User instance, ServerLevel serverLevel, BlockPos pos, Holder<GameEvent> gameEventHolder, GameEvent.Context context) throws Throwable {
