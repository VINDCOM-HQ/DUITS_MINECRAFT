...
import io.github.netherdeck.common.mod.server.block.DispenserBlockHooks;
...
public class ArmorItemMixin {
    ...
    private static void netherdeck$dispense(LivingEntity instance, EquipmentSlot equipmentSlot, ItemStack stack, BlockSource blockSource, ItemStack itemStack, @Local(ordinal = -1) ItemStack itemstack1) throws Throwable {
