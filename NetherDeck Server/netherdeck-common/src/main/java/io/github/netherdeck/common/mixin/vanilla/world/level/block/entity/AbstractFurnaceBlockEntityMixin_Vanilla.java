package io.github.netherdeck.common.mixin.vanilla.world.level.block.entity;
...
public abstract class AbstractFurnaceBlockEntityMixin_Vanilla {
    ...
    private static <E> E netherdeck$furnaceSmelt(NonNullList<E> instance, int i, @Local(ordinal = -1) ItemStack itemStack2, @Local(ordinal = -2) ItemStack itemStack1) throws Throwable {
        ...
        FurnaceSmeltEvent furnaceSmeltEvent = new FurnaceSmeltEvent(CraftBlock.at(NetherDeckCaptures.getTickingBlockEntity().getLevel(), NetherDeckCaptures.getTickingBlockEntity().getBlockPos()), source, result);
