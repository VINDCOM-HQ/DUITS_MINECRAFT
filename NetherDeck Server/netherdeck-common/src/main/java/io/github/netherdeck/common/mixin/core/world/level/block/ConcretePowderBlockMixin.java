...
public abstract class ConcretePowderBlockMixin extends FallingBlockMixin {
    ...
    public boolean netherdeck$blockForm(Level world, BlockPos pos, BlockState newState, int flags) throws Throwable {
    ...
    public BlockState netherdeck$blockForm(Block instance, BlockPlaceContext context) {
    ...
    public BlockState netherdeck$blockForm(Block instance, BlockState stateIn, Direction facing, BlockState facingState, LevelAccessor worldIn, BlockPos currentPos, BlockPos facingPos) {
