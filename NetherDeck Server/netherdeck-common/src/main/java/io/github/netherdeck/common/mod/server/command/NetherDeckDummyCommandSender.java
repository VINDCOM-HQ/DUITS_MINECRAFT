package io.github.netherdeck.common.mod.server.command;

import io.github.netherdeck.common.mod.server.permission.NetherDeckDummyPermissible;
...
public class NetherDeckDummyCommandSender extends NetherDeckDummyPermissible implements CommandSender {

    public CommandSourceStack stack;
    public Spigot spigot;

    public NetherDeckDummyCommandSender(CommandSourceStack stack) {
        this.stack = stack;
    }
