...
// Changes are made to use NetherDeck configuration system
public class VelocitySupport {

    public static boolean isEnabled() {
        return NetherDeckConfig.spec().getVelocity().isEnable();
    }
    ...
    public static boolean checkIntegrity(final FriendlyByteBuf buf) {
        ...
        try {
            ...
            mac.init(new SecretKeySpec(NetherDeckConfig.spec().getVelocity().getSecret().getBytes(java.nio.charset.StandardCharsets.UTF_8), "HmacSHA256"));
