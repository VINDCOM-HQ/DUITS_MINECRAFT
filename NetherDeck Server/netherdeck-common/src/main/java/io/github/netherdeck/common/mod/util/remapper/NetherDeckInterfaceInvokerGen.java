...
public class NetherDeckInterfaceInvokerGen implements PluginTransformer {

    public static final NetherDeckInterfaceInvokerGen INSTANCE = new NetherDeckInterfaceInvokerGen();
            ...
            for (Map.Entry<String, String> entry : set) {
                ...
                if (node != null && !node.name.equals(name)) {
                    ...
                    if (!extend) {
                        ...
                        NetherDeckServer.LOGGER.debug("Generated {} redirecting to {}", classNode.name + "/" + name + " " + desc, node.owner + "/" + node.name + " " + node.desc);
                    }
                }
            }
        }
