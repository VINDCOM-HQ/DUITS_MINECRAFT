...
import io.github.netherdeck.common.bridge.core.world.level.block.state.BlockBehaviourBridge;
...
public abstract class BlockBehaviourMixin implements BlockBehaviourBridge {
    ...
    private void netherdeck$setRadius(BlockState blockState, Level level, BlockPos blockPos, Explosion explosion, BiConsumer<ItemStack, BlockPos> biConsumer,
