...
import io.github.netherdeck.common.mixin.core.world.entity.MobMixin;
...
public abstract class SlimeMixin extends MobMixin {
    ...
    private transient List<LivingEntity> netherdeck$slimes;
    ...
    public void remove(Entity.RemovalReason p_149847_) {
        ...
        if (!this.level().isClientSide && i > 1 && this.isDeadOrDying()) {
            ...
            netherdeck$slimes = new ArrayList<>(k);
            ...
            for (int l = 0; l < k; ++l) {
                ...
                netherdeck$slimes.add(slimeentity);
            }
            if (CraftEventFactory.callEntityTransformEvent((net.minecraft.world.entity.monster.Slime) (Object) this, netherdeck$slimes, EntityTransformEvent.TransformReason.SPLIT).isCancelled()) {
                super.remove(p_149847_);
                netherdeck$slimes = null;
                return;
            }
            for (int l = 0; l < netherdeck$slimes.size(); l++) {
                // Apotheosis compat, see https://github.com/IzzelAliz/NetherDeck/issues/1078
                float f2 = ((float) (l % 2) - 0.5F) * f;
                float f3 = ((float) (l / 2) - 0.5F) * f;
                net.minecraft.world.entity.monster.Slime living = (net.minecraft.world.entity.monster.Slime) netherdeck$slimes.get(l);
