...
public abstract class BoatItemMixin extends Item {
    ...
    private void netherdeck$interact(Level level, Player player, InteractionHand interactionHand,
    ...
    private boolean netherdeck$entityPlace(Level instance, Entity entity, @NotNull Level worldIn, Player playerIn, @NotNull InteractionHand handIn,
                                         @Local(ordinal = 0) ItemStack itemstack, @Local(ordinal = 0) HitResult result) throws Throwable {
