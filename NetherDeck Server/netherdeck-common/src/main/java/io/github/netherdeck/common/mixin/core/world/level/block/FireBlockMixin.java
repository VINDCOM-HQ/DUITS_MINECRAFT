...
public abstract class FireBlockMixin extends BaseFireBlockMixin implements FireBlockBridge {
    ...
    public boolean netherdeck$fireSpread(ServerLevel world, BlockPos mutablePos, BlockState newState, int flags,
    ...
    public boolean netherdeck$extinguish1(ServerLevel world, BlockPos pos, boolean isMoving) {
    ...
    public BlockState netherdeck$blockFade(net.minecraft.world.level.block.Block block, BlockState stateIn, Direction facing, BlockState facingState, LevelAccessor worldIn, BlockPos currentPos, BlockPos facingPos) {
