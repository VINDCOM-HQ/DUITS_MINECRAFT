...
import io.github.netherdeck.common.mod.inventory.NetherDeckSpecialIngredient;
...
public interface CraftRecipeMixin {
    ...
    default Ingredient toNMS(RecipeChoice bukkit, boolean requireNotEmpty) {
        ...
        } else if (bukkit instanceof NetherDeckSpecialIngredient) {
            stack = ((NetherDeckSpecialIngredient) bukkit).getIngredient();
        } else {
    ...
    static RecipeChoice toBukkit(Ingredient list) {
        ...
        if (list.getClass() != Ingredient.class) {
            return new NetherDeckSpecialIngredient(list);
        }
