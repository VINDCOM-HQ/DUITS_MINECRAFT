...
import io.github.netherdeck.common.bridge.core.command.CommandsBridge;
...
import io.github.netherdeck.common.mod.util.BukkitDispatcher;
...
public abstract class CommandsMixin implements CommandsBridge {
    ...
    private <S> boolean netherdeck$canUse(CommandNode<S> commandNode, S source) {
