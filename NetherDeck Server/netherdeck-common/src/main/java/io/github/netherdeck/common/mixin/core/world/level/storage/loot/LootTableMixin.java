...
import io.github.netherdeck.common.bridge.core.world.storage.loot.LootTableBridge;
...
public abstract class LootTableMixin implements LootTableBridge {
    ...
    private ObjectArrayList<ItemStack> netherdeck$nonPluginEvent(LootTable lootTable, LootContext context, Container inv) throws Throwable {
