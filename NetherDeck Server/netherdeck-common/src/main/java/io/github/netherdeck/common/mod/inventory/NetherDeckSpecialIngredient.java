package io.github.netherdeck.common.mod.inventory;
...
public class NetherDeckSpecialIngredient implements RecipeChoice {

    private final Ingredient ingredient;

    public NetherDeckSpecialIngredient(Ingredient ingredient) {
    ...
    public boolean equals(Object o) {
        ...
        NetherDeckSpecialIngredient that = (NetherDeckSpecialIngredient) o;
