package io.github.netherdeck.common.mod.server.api;
...
public class DefaultTickingTracker implements TickingTracker {
    ...
    public Entity getTickingEntity() {
        var tickingEntity = NetherDeckCaptures.getTickingEntity();
    ...
    public Block getTickingBlock() {
        var level = NetherDeckCaptures.getTickingLevel();
        var pos = NetherDeckCaptures.getTickingPosition();
    ...
    public TileState getTickingBlockEntity() {
        var blockEntity = NetherDeckCaptures.getTickingBlockEntity();
        if (blockEntity != null) {
