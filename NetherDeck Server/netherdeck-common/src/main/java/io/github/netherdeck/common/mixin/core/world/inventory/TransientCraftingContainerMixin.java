...
public abstract class TransientCraftingContainerMixin implements CraftingInventoryBridge, Container {
    ...
    @ShadowConstructor
    public void netherdeck$constructor(AbstractContainerMenu eventHandlerIn, int width, int height) {
        throw new RuntimeException();
    }

    @CreateConstructor
    public void netherdeck$constructor(AbstractContainerMenu eventHandlerIn, int width, int height, Player owner) {
        netherdeck$constructor(eventHandlerIn, width, height);
        this.owner = owner;
    }
