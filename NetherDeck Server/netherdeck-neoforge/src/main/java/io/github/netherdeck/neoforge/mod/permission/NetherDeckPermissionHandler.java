package io.github.netherdeck.neoforge.mod.permission;
...
public final class NetherDeckPermissionHandler implements IPermissionHandler {

    private final IPermissionHandler delegate;

    public NetherDeckPermissionHandler(IPermissionHandler delegate) {
    ...
    public ResourceLocation getIdentifier() {
        return ResourceLocation.parse("netherdeck:permission");
    }
