package io.github.netherdeck.fabric.boot;
...
public class NetherDeckImplementer extends GameTransformer {
    ...
    public NetherDeckImplementer(GameTransformer delegate, FabricLauncher launcher) throws Exception {
