...
public abstract class EntityMixin_Forge implements EntityBridge, IForgeEntity {
    ...
    private Vec3 netherdeck$setLava(FluidState instance, BlockGetter level, BlockPos pos) throws Throwable {
    ...
    public Collection<ItemEntity> netherdeck$forceDrops(Entity entity) throws Throwable {
