...
import io.github.netherdeck.forge.mod.plugin.messaging.NetherDeckForgeMessaging;
...
public abstract class StandardMessengerMixin_Forge implements Messenger, MessengerBridge {
    ...
    public NetherDeckPluginChannel<?> netherdeck$setupChannel(ResourceLocation channel, Set<PluginMessageListenerRegistration> incoming, Set<Plugin> outgoing) {
        return NetherDeckForgeMessaging.setupChannel(this, channel, incoming, outgoing);
    }
}
