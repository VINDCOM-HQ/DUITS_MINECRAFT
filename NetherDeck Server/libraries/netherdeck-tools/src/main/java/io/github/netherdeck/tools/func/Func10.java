...
public interface Func10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> extends Func<R> {
  ...
  static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> Func10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> y(
      Func1<Func10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>, Func10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>> comp) {
    return comp.apply((p1,p2,p3,p4,p5,p6,p7,p8,p9,p10) -> y(comp).apply(p1,p2,p3,p4,p5,p6,p7,p8,p9,p10));
  }
}
