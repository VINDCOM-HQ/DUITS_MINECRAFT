...
import io.github.netherdeck.i18n.conf.ConfigSpec;
...
public class NetherDeckConfig {

    private static NetherDeckConfig instance;

    private final CommentedConfigurationNode node;
    private final ConfigSpec spec;

    public NetherDeckConfig(CommentedConfigurationNode node) throws ObjectMappingException {
        this.node = node;
    ...
    private static void load() throws Exception {
        ...
        cur.getNode("locale", "current").setValue(NetherDeckLocale.getInstance().getCurrent());
        fillComments(cur, NetherDeckLocale.getInstance());
        instance = new NetherDeckConfig(cur);
        loader.save(cur);
    }

    private static void fillComments(CommentedConfigurationNode node, NetherDeckLocale locale) {
